...
data_root = "/mimer/NOBACKUP/groups/alvis_cvl/datasets/nuScenes/"
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='../data/vad_nuscenes_infos_temporal_val.pkl',#'../data/vad_nuscenes_infos_temporal_train.pkl',
    ...
    val=dict(
        ...
        data_root=data_root,
        pc_range=point_cloud_range,
        ann_file='../data/vad_nuscenes_infos_temporal_val.pkl',
